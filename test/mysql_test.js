  ...
  .addBatch({
    createTable: {
      ...
      'has column metadata for the event table': {
        ...
        'that has text str column that is unique and has a default value': function (
          err,
          columns
        ) {
        ...
        'that has text strDefaultNull column that has a default null value': function (
          err,
          columns
        ) {
        ...
        'that has boolean bl column with a default value': function (
          err,
          columns
        ) {
        ...
        'that has ct column with current timestamp with precision 3 as defaultValue': function (
          err,
          columns
        ) {
